...
static const http_route_t g_web_api_routes[] = {
    ...
    { HTTP_METHOD_GET,  "/hotspot-detect.html",          false, handle_system_captive_probe },
    { HTTP_METHOD_GET,  "/generate_204",                 false, handle_system_captive_probe_android },
    { HTTP_METHOD_GET,  "/gen_204",                      false, handle_system_captive_probe_android },
    { HTTP_METHOD_GET,  "/canonical.html",               false, handle_system_captive_probe },
    { HTTP_METHOD_GET,  "/ncsi.txt",                     false, handle_system_captive_probe_android },
    { HTTP_METHOD_GET,  "/connecttest.txt",              false, handle_system_captive_probe_android },
